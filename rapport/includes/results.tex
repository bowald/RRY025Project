...
\section{Results from applying homomorphic filtering}
	...
	\subsection{Results on the image provided with the project}
		...
		figure~\ref{fig:low_freq_supp} may not be the most aesthetic image to look at, but it 
		greatly enhances the information hidden in the low frequencies, especially in the darker areas.
		Noteworthy is also that noise gets amplified as the lower frequencies gets suppressed.
		\begin{figure}[h!]
		\centering
